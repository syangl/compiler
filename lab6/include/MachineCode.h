...
public:
    ...
    StackMInstrcuton(MachineBlock* p, int op, std::vector<MachineOperand*> srcs, MachineOperand* src1,
...
public:
    ...
    int getCmpOpcond() const {return cmpOpcond;};
    void setCmpOpcond(int cond) {cmpOpcond = cond;};
